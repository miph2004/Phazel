...
import quickVisualize from "./visualizers/quickVisualize";
  ...
  runSort(array, animSpeed, sortAlgo, arrayBars) {
    if (sortAlgo === "") {
      ...
      switch (sortAlgo) {
        ...
        case "quickSort":
          const quickSortAnimations = quickSort(array.slice());
          quickVisualize(quickSortAnimations, animSpeed, arrayBars);
          break;
